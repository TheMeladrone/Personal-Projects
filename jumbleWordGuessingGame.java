...
class jumbleWordGuessingGame{
  ...
  public static void main(String[] args){
    ...
    do{
      ...
      System.out.println("Do you want to continue type yes?"); //asks them if they want to continue
